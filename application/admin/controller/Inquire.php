...
class Inquire extends Controller
{
	...
	public function index()
	{
		// $a = new Chaboshi();
		// echo $a ->test();
		// $vin = 'WP0CA298XBS710108';
		// echo $a->buy_report($vin);
		// userid=222671
		// &nonce=5c4a78c05d67b×tamp=1548384448383
		// &vin=LFV3A23C0F3411006
		// &signature=ycm12sYsd%2F8t%2FAqiE7ywP2sfS2E%3D
	
		require  ROOT_PATH.'/extend/mcbn/CBS_SDK.php'; 
		// $userid = '222671';//分配的用户ID  不能为空  

		// $keySecret = 'd60aae36d3df257e77bdacb6eed6310e';//分配的用户秘钥 不能为空

		// $onLine = false; //是否为生产环境

		// $cbs = \CBSBuilder::newCBSBuilder($userid, $keySecret, $onLine); //构造CBS_Warranty类
		...
		// } else {
		//     $p = array();
		//     $p['vin'] = 'LFV3A23C0F3411006';
		//     echo $cbs->sendPost('/report/buy_report', $p);die;
		// }
		die;
